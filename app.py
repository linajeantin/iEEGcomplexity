...
# Lina Jeantin, Lionel Naccache, Nov. 2025
...
- **Source data files for all metrics, cortical regions and sleep stages**: <link will be provided at time of publication>
...
**Need perfectly customisable parameters for computing EEG complexity?** 
- You can find the Python source code that you can adapt for your own analyses here: <link will be provided at time of publication>
